...
PLT_MediaRenderer::SetupServices()
{
...

    {
        ...
        service->SetStateVariable("CurrentTransportActions", "Play,Pause,Stop,Seek,Next,Previous,GetPositionInfo");
...
{
    printf("xia  OnGetPositionInfo:::::%s   line %d \n",__FUNCTION__,__LINE__);
    if (m_Delegate) {
        printf("xia  OnGetPositionInfo:::::%s   line %d \n",__FUNCTION__,__LINE__);
